...
if (isset($_GET['delete'])) {
    ...
    header("Location: rezervacie_ubytovanie.php");
    exit();
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Rezervácie ubytovanie</title>
    <link href="../assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="container mt-4">
    <h1>Rezervácie Ubytovanie</h1>
    ...
    <div class="border rounded p-2 mb-3 bg-light">
        ...
        <strong>Dátum od:</strong> <?= htmlspecialchars($res['date_from'] ?? '') ?><br>
        <strong>Dátum do:</strong> <?= htmlspecialchars($res['date_to'] ?? '') ?><br>
